...
/* Fades out any objects between the player and this transform.
    ...
    */
    ...
    function LateUpdate () {
        ...
        //MY LAYERMASK CODE
//        layerMask = target.gameObject.GetComponentInChildren(BlobOneSurface).ReturnIgnoreLayer();
...
//            Debug.DrawRay(from + relativeOffset, to - from,  Color.green);
            for (var hit : RaycastHit in hits)
            {
            	//MY CHECK PLAYER TAG CODE
